Crossbeams::MenuMigrations::Migrator.migration('Framework') do
  up do
    ...
    add_program_function 'Staging Completed', functional_area: 'Pack Material', program: 'Adjustments', url: '/list/mr_bulk_stock_adjustments/with_params?key=staging_completed', seq: 4, group: 'Consumption'
    add_program_function 'Carton Assembly', functional_area: 'Pack Material', program: 'Adjustments', url: '/list/mr_bulk_stock_adjustments/with_params?key=carton_assembly', seq: 5, group: 'Consumption'
