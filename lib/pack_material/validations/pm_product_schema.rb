...
module PackMaterialApp
  PmProductSchema = Dry::Validation.Params do # rubocop:disable Metrics/BlockLength
    ...
    optional(:reference_dimension_2, Types::StrippedString).filled(:str?)
    ...
    optional(:analysis_code, Types::StrippedString).filled(:str?)
    optional(:season_year_use, Types::StrippedString).filled(:str?)
