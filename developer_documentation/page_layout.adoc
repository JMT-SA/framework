...
|caption
|String and optionally level number. e.g. `form.caption 'New thing', level: 2`.
|Render a caption above the form (hidden for remote forms). The level can be 1..4 to render within h1..h4 tags. Default level is 1.
