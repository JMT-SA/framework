...
class Framework < Roda
  route 'config', 'pack_material' do |r|
    ...
    r.on 'material_resource_types', Integer do |id|
      interactor = PackMaterialApp::ConfigInteractor.new(current_user, {}, { route_url: request.path, request_ip: request.ip }, {})
    ...
    r.on 'pack_material_products', Integer do |id|
      interactor = PackMaterialApp::PmProductInteractor.new(current_user, {}, { route_url: request.path, request_ip: request.ip }, {})
