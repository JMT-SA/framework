...
class TestMatresTypeRoutes < RouteTester
  ...
  def test_update
    ...
    patch_as_fetch 'pack_material/config/material_resource_types/1', {}, 'rack.session' => { user_id: 1, last_grid_url: DEFAULT_LAST_GRID_URL }
  ...
  def test_delete
    ...
    delete_as_fetch 'pack_material/config/material_resource_types/1', {}, 'rack.session' => { user_id: 1, last_grid_url: DEFAULT_LAST_GRID_URL }
