Crossbeams::MenuMigrations::Migrator.migration('Framework') do
  up do
    ...
    add_program 'Configuration', functional_area: 'Pack Material'
    ...
    add_program 'Replenish', functional_area: 'Pack Material'
    ...
    add_program 'Transactions', functional_area: 'Pack Material'
    ...
    add_program 'Tripsheets', functional_area: 'Pack Material'
