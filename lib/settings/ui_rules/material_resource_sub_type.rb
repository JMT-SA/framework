...
module UiRules
  class MaterialResourceSubTypeRule < Base
    ...
    def set_show_fields
      # material_resource_type_id_label = MaterialResourceRepo.new.find_material_resource_type(@form_object.material_resource_type_id)&.type_name
    ...
    def common_fields
      {
        material_resource_type_id: { renderer: :select, options: MaterialResourceRepo.new.for_select_material_resource_types, caption: 'Type' },
        sub_type_name: {}
      }
    end
